...
export async function execute({ isDev, packageName}, registry) {
...
export const description = "Installs a package using the detected package manager (pnpm, npm, yarn)";
export const parameters = z.object({
  packageName: z.string().describe("One or more package names to install, separated by spaces."),
